...
$vimeo = new phpVimeo('9074e5b1506a9cde97ebdd77fe6a242d742cd5d6', '8b93b9a79bda61821557e08d07eb9d22d9ecef75');
...
<?php 
$theID = $videos->videos->video[0]->id;
echo $theID;
echo "<br/><br/>";
...
try {
    ...
    //this will add the video to the ljudbildspel vimeo group
    //$vimeo->call('vimeo.groups.addVideo', array('oauth_token' => $token['oauth_token'], 'group_id' => 'ljudbildspel', 'video_id' => $theID));

    //add user to group
    // $vimeo->call('vimeo.groups.join', array('group_id' => 'ljudbildspel'));
